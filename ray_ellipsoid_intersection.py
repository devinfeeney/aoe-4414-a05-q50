...
# Output:
# If an intersection exists, prints the x, y, and z coordinates of the intersection point.
...
# "constants"
R_EQUATOR = 6378.137  # Earth semi-major axis in km
R_POLAR = 6356.752    # Earth semi-minor axis in km
